...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      { source: "/products/mixed-mens-lacoste-25", destination: "/products/lacoste-jumpers-cardigans", permanent: true },
      // Mixed Men's Lacoste was folded into Lacoste Jumpers & Cardigans, which
      // was briefly listed as "lacoste-knitwear" before taking the older address.
      { source: "/products/mixed-mens-lacoste", destination: "/products/lacoste-jumpers-cardigans", permanent: true },
      { source: "/products/lacoste-knitwear", destination: "/products/lacoste-jumpers-cardigans", permanent: true },
